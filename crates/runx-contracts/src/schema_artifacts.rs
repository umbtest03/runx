...
use crate::{
    ...
    CredentialEnvelope, Decision, DevReport, DoctorReport, EffectSettlementReceipt,
    ...
    ExternalAdapterResponse, FeedEntry, Fixture, HandoffSignal, HandoffState, LedgerEntry,
    OperationalPolicy, OperationalProposal, Opportunity, Output, PacketIndex, Question, Receipt,
    Redaction, Reference, ReferenceLink, ReflectionEntry, RegistryBinding, ResolutionRequest,
    ResolutionResponse, ReviewReceiptOutput, RunSummary, RunxListReport, ScopeAdmission, Selection,
    SelectionCycle, Signal, SkillBinding, SourcePacket, SuppressionRecord, Target,
    TargetTransitionEntry, ThesisAssessment, ThreadOutboxProviderFetch,
...
pub fn generated_schema_artifacts() -> Vec<SchemaArtifact> {
    vec![
        ...
        artifact::<EffectSettlementReceipt>("effect-settlement-receipt.schema.json"),
