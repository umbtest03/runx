...
pub(super) fn target_corpus() -> Vec<(&'static str, Value)> {
    let valid = json!({
...
pub(super) fn opportunity_corpus() -> Vec<(&'static str, Value)> {
    let valid = json!({
...
pub(super) fn thesis_assessment_corpus() -> Vec<(&'static str, Value)> {
    let valid = json!({
...
pub(super) fn selection_corpus() -> Vec<(&'static str, Value)> {
    let valid = json!({
...
pub(super) fn skill_binding_corpus() -> Vec<(&'static str, Value)> {
    let valid = json!({
...
pub(super) fn target_transition_entry_corpus() -> Vec<(&'static str, Value)> {
    let valid = json!({
...
pub(super) fn selection_cycle_corpus() -> Vec<(&'static str, Value)> {
    let valid = json!({
...
pub(super) fn reflection_entry_corpus() -> Vec<(&'static str, Value)> {
    let valid = json!({
...
pub(super) fn feed_entry_corpus() -> Vec<(&'static str, Value)> {
    let valid = json!({
