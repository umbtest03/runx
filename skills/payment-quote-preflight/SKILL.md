...
credentials. A result from this skill is evidence for a later Decision, not a
payment.
...
- `requested_payment_authority`: the requested `payment` authority bounds for
  the later reservation decision.
