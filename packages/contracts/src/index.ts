...
export const runxContractSchemas = {
  ...
  target: runxSchemaArtifacts["target.schema.json"],
  opportunity: runxSchemaArtifacts["opportunity.schema.json"],
  thesisAssessment: runxSchemaArtifacts["thesis-assessment.schema.json"],
  selection: runxSchemaArtifacts["selection.schema.json"],
  skillBinding: runxSchemaArtifacts["skill-binding.schema.json"],
  targetTransitionEntry: runxSchemaArtifacts["target-transition-entry.schema.json"],
  selectionCycle: runxSchemaArtifacts["selection-cycle.schema.json"],
  reflectionEntry: runxSchemaArtifacts["reflection-entry.schema.json"],
  feedEntry: runxSchemaArtifacts["feed-entry.schema.json"],
