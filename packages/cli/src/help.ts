...
export function writeUsage(stream: Writable, env: NodeJS.ProcessEnv = process.env): void {
  ...
  stream.write(
    [
      ...
      "  runx skill add <registry-ref> [--version version] [--to skills-dir] [--registry url] [--digest sha256] [--json]",
      "  runx skill add <github-url> [--version git-ref] [--registry api-url] [--json]",
      ...
      "  runx list",
      "  runx doctor",
      "  runx policy inspect fixtures/operational-policy/nitrosend-like.json",
